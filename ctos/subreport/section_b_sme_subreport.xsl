    ...
    <xsl:template name="section_b_CG_template">        
        <xsl:if test="r:accounts/r:account">                     
            ...
            <table class="table-financial">
                <tr>
                    <td class="header">Financial Year End</td>                                            
                    
                    <xsl:for-each select="r:accounts/r:account">                        
                        <td width="16%" class="background-grey">
                            <xsl:call-template name="check_empty_string">
                ...
                <tr>                    
                    ...
                    <xsl:for-each select="r:accounts/r:account">
                        <td width="16%" class="text-right bold">
                            <xsl:variable name="turnover_growth">
                                <xsl:call-template name="check_empty_string">
                                    <xsl:with-param name="value" select="r:turnover_growth"/>
                                </xsl:call-template>
                            </xsl:variable>
                            <xsl:copy-of select="$turnover_growth" />
                            <xsl:if test="number($turnover_growth) = $turnover_growth">%</xsl:if>
                        </td>
                    </xsl:for-each>
